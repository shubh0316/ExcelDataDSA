...
namespace ExcelDataDSA.DataStructures.MyLinkedList
{
    internal class MyDoublyLinkedList<T> where T : IComparable<T>
    {
        ...
        public MyDoublyLinkedList(IEnumerable<T> value)
        {
            if(FirstNode == null)
            {
        ...
        private void Add(Node<T> value)
        {
            ...
            {
                LastNode.NextValue = value;
                PreviousNode = LastNode.NextValue;
        ...
        internal static void SortAllAlgorithmForDoublyLinkedList()
        {
            var result = FetchData.GetData();
            MyDoublyLinkedList<Person> DoubleLinkedList = new MyDoublyLinkedList<Person>(result);


            Stopwatch timeForDoubleLinkedList = Stopwatch.StartNew();
            DoubleLinkedList.BubbleSort();
            timeForDoubleLinkedList.Stop();
            TimeSpan timeSpanForBubbleSort = timeForDoubleLinkedList.Elapsed;
            Console.WriteLine("the time taking for Bubble sort in doubbly Linkedlist : {0}", timeSpanForBubbleSort.TotalSeconds + "Seconds");

            timeForDoubleLinkedList.Restart();
            DoubleLinkedList.SelectionSort();
            timeForDoubleLinkedList.Stop();
            TimeSpan timeForSelectionSort = timeForDoubleLinkedList.Elapsed;
            Console.WriteLine("The time taking for Selection sort in doubly linkedlist : {0}", timeForSelectionSort.TotalSeconds + "Seconds");

            timeForDoubleLinkedList.Restart();
            DoubleLinkedList.MergeSort();
            timeForDoubleLinkedList.Stop();
            TimeSpan timeForMergeSort = timeForDoubleLinkedList.Elapsed;
            Console.WriteLine("The time taking for Merge sort in doubly linkedlist: {0}", timeForMergeSort.TotalSeconds + "Seconds");

            timeForDoubleLinkedList.Restart();
            DoubleLinkedList.InsertionSort();
            timeForDoubleLinkedList.Stop();
            TimeSpan timeForInsertionSort = timeForDoubleLinkedList.Elapsed;
            Console.WriteLine("The time taking for Insertion sort in doubly linkedlist : {0}", timeForInsertionSort.TotalSeconds + "Seconds");
